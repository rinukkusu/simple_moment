...
void main() {
  group('A group of tests', () {
    ...
    test('Moment.add(years:1, months: 4, days: 6)', () {
      ...
      expect(
        currentDate.add(years: 1, months: 4, days: 6).date,
    ...
    test('Moment.substract(years:1, months: 2, days: 3)', () {
      ...
      Moment currentDate = Moment.fromDate(currentDateString);
      expect(
        currentDate.subtract(years: 1, months: 2, days: 3).date, 
    ...
    test('Moment.formatLocalized(pattern)', () async {
      Moment currentDate = Moment
        .fromDate(DateTime.parse("2020-06-03 11:25:28.001"))
        .locale(new LocaleDe());
        
      await initializeDateFormatting(currentDate.usedLocale.localeString);

      expect(currentDate.formatLocalized("LLLL"), "Juni");
    });
